...
import { Group, Mesh, Color, SRGBColorSpace, Material } from "three";
...
const MacbookModel14: React.FC<MacbookModel14Props> = (props) => {
  ...
  useEffect(() => {
    scene.traverse((child) => {
      if ((child as Mesh).isMesh) {
        ...
        if (!noChangeParts.includes(mesh.name) && mesh.material) {
